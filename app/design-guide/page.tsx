...
import { CheckCircle, Thermometer, Zap, Weight } from "lucide-react"

export default function DesignGuide() {
  return (
    <div className="min-h-screen bg-white text-black print:text-black" style={{ fontSize: "11px", lineHeight: "1.3" }}>
      {/* Header */}
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Manufacturing, quality checks, packaging, and shipment.</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-xs font-bold">
            ...
            <p className="text-xs mt-3 text-gray-600 bg-blue-50 p-2 rounded">
              <strong>Fast Track Option:</strong> If design and tooling are already completed, production and delivery
              can be achieved in 15 days.
            </p>
          </div>
          ...
          <div className="grid grid-cols-4 gap-4">
            <div>
              ...
              <p className="text-xs text-gray-700">
                Leading UAV manufacturer needed to reduce drone weight by 50% while maintaining structural integrity for
                extended flight missions in harsh Indian climate conditions. Original aluminum frame was 2.1kg.
              </p>
            </div>
            <div>
